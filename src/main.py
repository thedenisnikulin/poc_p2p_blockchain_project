...
def main():
    ...
    while 1:
        ...
        try:
            ...
            peer.connect(Server.read_address())
        ...
        try:
            ...
            super_peer.close_connections()  # TODO program doesn't quit on KeyboardInterrupt
            sys.exit()
        else:
            # "else" instruction executes when there were no exceptions raised.
